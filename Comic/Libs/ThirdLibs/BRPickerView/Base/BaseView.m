...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.frame = IS_IPAD?CGRectMake(10, 14,80, 36):CGRectMake(5, 8, 60, 28);
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:IS_IPAD?23:15.0f];
        [_leftBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_leftBtn setTitle:@"Batal" forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = IS_IPAD?CGRectMake(SCREEN_WIDTH - 90, 14,80, 36): CGRectMake(SCREEN_WIDTH - 65, 8, 60, 28);
        _rightBtn.titleLabel.font = [UIFont systemFontOfSize:IS_IPAD?23:15.0f];
        [_rightBtn setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
        [_rightBtn setTitle:@"Yakin" forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:IS_IPAD?26:18];
